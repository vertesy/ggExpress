...
```mermaid
 flowchart LR 
  ...
  qviolin(qviolin) --> .assertMaxCategories(.assertMaxCategories)
  ...
  qstripchart(qstripchart) --> qqqAnnotateTopLabels(qqqAnnotateTopLabels)
  qstripchart(qstripchart) --> qqqList.2.DF.ggplot(qqqList.2.DF.ggplot)
  qstripchart(qstripchart) --> .assertMaxCategories(.assertMaxCategories)
  ...
  qqqSummarize_mean_median(qqqSummarize_mean_median) --> qqqList.2.DF.ggplot(qqqList.2.DF.ggplot)
  qpie(qpie) --> qqqNamed.Vec.2.Tbl(qqqNamed.Vec.2.Tbl)
  qpie(qpie) --> qqSave(qqSave)
  qpie(qpie) --> qMarkdownImageLink(qMarkdownImageLink)
  qmosaic(qmosaic) --> qqSave(qqSave)
  qmosaic(qmosaic) --> qMarkdownImageLink(qMarkdownImageLink)
  ...
  qheatmap(qheatmap) --> qqSave(qqSave)
  qheatmap(qheatmap) --> qMarkdownImageLink(qMarkdownImageLink)
  ...
  qboxplot(qboxplot) --> .assertMaxCategories(.assertMaxCategories)
  qboxplot(qboxplot) --> qqSave(qqSave)
  qboxplot(qboxplot) --> qMarkdownImageLink(qMarkdownImageLink)
  qbarplot.stacked.from.wide.df(qbarplot.stacked.from.wide.df) --> qqSave(qqSave)
  qbarplot.stacked.from.wide.df(qbarplot.stacked.from.wide.df) --> qMarkdownImageLink(qMarkdownImageLink)
